...
function setup() {
  ...
  ball= Matter.Bodies.circle(100,200,20);
  ...
  block22=new Block(625,175,30,40);
  //level two
  ...
  block29=new Block(702,55,30,40);
}
function draw() {
  background(56,44,44); 
  image(ball_img,ball.position.x,ball.position.y,20,20);
  textSize(20);
  fill("lightyellow");
  ground.display();
  stand1.display();
...
function keyPressed(){
  if(keyCode === 32 && this.ball.speed<1){
      ...
      Matter.Body.setPosition(this.ball, {x: 250 , y: 50});
  }
}